...
FACTS:
- Slack is a supported Hermes messaging platform.
- gateway/toolset layering is the same family as other adapters.

CONTRACT:
- platform adapter docs are required before changing platform routing.

NON_GOALS:
- no Slack app setup guide

FORBIDDEN_MISUSE:
- conflating Slack workspace behavior with Telegram behavior

OPEN_QUESTIONS:
- exact adapter constraints are omitted here
