...
|---|---|---:|---|
| DAIR lesson-generator | `docs/codex_source/tools/dair_lesson_generator/README.md`, `SKILL.md` | imported_reference | Primary reference for compact lesson/course artifacts |
...
They are local reference copies only; active Codex skills still live in `/opt/ai-starter-community/.agents/skills/**`.
